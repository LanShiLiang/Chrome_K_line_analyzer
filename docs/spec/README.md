...
本目录是 Chrome 浏览器环境下、当前兼容 TradingView、Binance 和同花顺的纯前端 K 线分析器插件 Markdown 技术方案文档包。
...
|    4 | [`04_行情数据采集_接口嗅探与网站适配设计方案.md`](./04_行情数据采集_接口嗅探与网站适配设计方案.md)                     | 多站点采集、独立适配器与 OHLCV 标准化              | 高         |
...
|    9 | [`09_国际化与双语发布实施方案.md`](./09_国际化与双语发布实施方案.md)                                                   | UI、Manifest、商店素材和用户文档双语化             | 高         |
...
7. 实现 UI、Manifest、商店素材和用户文档双语化前读 `09_国际化与双语发布实施方案.md`。
8. 写测试和验收前读 `07_测试验收_性能与兼容性方案.md`。
9. 补齐工程脚本、调试流程、发布和排障前读 `08_构建发布_开发调试_运维排障与上线方案.md`。
...
6. UI 国际化不得修改内部英文状态关键字、错误码、原因码和消息协议；面向用户的文案统一通过语言资源展示。
