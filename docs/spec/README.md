...
本目录是 Chrome 浏览器环境下、仅兼容 TradingView 的纯前端 K 线分析器插件 Markdown 技术方案文档包。
...
|    4 | [`04_行情数据采集_接口嗅探与网站适配设计方案.md`](./04_行情数据采集_接口嗅探与网站适配设计方案.md)                     | WebSocket Hook、TradingView 适配与 OHLCV 标准化    | 高         |
