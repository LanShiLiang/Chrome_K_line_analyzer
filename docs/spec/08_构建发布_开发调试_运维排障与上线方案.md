...
| Inject Script  | 目标页面主世界 Console            | Fetch/XHR Hook 是否生效  |
...
| 场景                 | 处理                                               |
| -------------------- | -------------------------------------------------- |
| TradingView 协议失效 | 禁用分析入口，提示暂不可用，更新适配器并发布热修复 |
